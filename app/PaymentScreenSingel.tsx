...
const PaymentScreenSingel = () => {
  ...
  console.log("Product ID:",parsedProduct);

  const createTicket = async () => {
    try {
      const uid = await AsyncStorage.getItem('uid')
      const response = await fetch(`${API.BASE_URL}/create_singel_app_ticket`, {
        method: 'POST',
...
export default PaymentScreenSingel;